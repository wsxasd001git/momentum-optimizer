            ...
            <div class="ms-option-row">
                ...
                <div class="ms-option ms-option-advanced">
                    ...
                    <div class="ms-option-body" id="ms-dynamic-body" style="display: none;">
                        <label><?php esc_html_e('Целевая волатильность:', 'momentum-screener'); ?> <span id="ms-marketvol-value">25</span>%</label>
                        <input type="range" id="ms-marketvol" min="15" max="50" step="5" value="25">
                        <p><?php esc_html_e('Размер портфеля автоматически адаптируется: чем выше волатильность, тем больше диверсификация', 'momentum-screener'); ?></p>

                        <div class="ms-divider"></div>

                        <label><?php esc_html_e('Порог изменения (гистерезис):', 'momentum-screener'); ?> <span id="ms-hysteresis-value">10</span>%</label>
                        <input type="range" id="ms-hysteresis" min="5" max="25" step="5" value="10">
                        <p><?php esc_html_e('Размер портфеля меняется только если отклонение превышает порог (избегает частых изменений)', 'momentum-screener'); ?></p>
                    </div>
                </div>
            </div>
        </div>
